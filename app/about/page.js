  ...
  return (
    <main className="aboutPage container">
      ...
      <p>
        ...
        Мы создаём дома, в которых хочется дышать, думать и быть собой.
      </p>
      <p><strong>LAVEA — гармония инженерии и эмоций.</strong></p>

      <h2>LAVEA в цифрах</h2>
      <ul className="stats">
        <li><strong>8 лет работы:</strong> мы создаём интерьеры премиум-класса с 2017 года — от московских квартир до вилл у моря.</li>
        <li><strong>120 реализованных проектов:</strong> каждый проект проходит инженерную проверку и авторский надзор.</li>
        <li><strong>17 городов:</strong> Москва, Санкт-Петербург, Сочи, Казань, Алания, Дубай, Бодрум и другие.</li>
        <li><strong>98% довольных клиентов:</strong> большинство заказчиков возвращаются и рекомендуют нас своим близким.</li>
      </ul>
      <p><strong>LAVEA — студия, где точность инженерии превращается в эстетику.</strong></p>

      <h2>Подход и гарантии</h2>
      <ul>
        <li><strong>Техническая лаборатория чертежей:</strong> каждый проект проходит внутреннюю инженерную проверку перед реализацией.</li>
        <li><strong>Авторский надзор по SLA:</strong> фото- и видеоотчёты с объекта, регулярные визиты и контроль каждой детали.</li>
        <li><strong>Прозрачные сметы:</strong> все цифры открыты: вы видите структуру расходов и скидки от поставщиков.</li>
        <li><strong>Один куратор:</strong> вы общаетесь с одним человеком, который отвечает за всё — от идеи до последнего штриха.</li>
        <li><strong>Интерьер с ДНК владельца:</strong> мы создаём не «глянец для портфолио», а пространства, в которых вам действительно комфортно жить.</li>
      </ul>
